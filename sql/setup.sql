...
insert into categories (name_en, name_ar, icon, sort_order) values
  ('Dresses',   'فساتين',    'fas fa-female',      1),
  ('Tops',      'بلوزات',    'fas fa-tshirt',      2),
  ('Pants',     'بناطيل',    'fas fa-stream',      3),
  ('Sets',      'أطقم',      'fas fa-layer-group', 4),
  ('T-Shirts',  'تيشيرتات',  'fas fa-tshirt',      5),
  ('Skirts',    'جيبات',     'fas fa-circle',      6),
  ('Kids',      'أطفال',     'fas fa-child',       7)
